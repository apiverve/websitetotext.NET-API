...
namespace APIVerve
{
    public class WebsitetoTextAPIClient
    {
        ...
        public WebsitetoTextAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }

        public WebsitetoTextAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public ResponseObj Execute(websitetotextQueryOptions options)
        {
            try
            {
                if (_isDebug)
